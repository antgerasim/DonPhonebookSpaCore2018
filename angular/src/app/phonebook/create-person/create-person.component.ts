...
export class CreatePersonComponent extends AppComponentBase {
    @ViewChild('createPersonModal') modal: ModalDirective; //in templateUrl <div bsModal #createPersonModal="bs-modal" class="modal fade"
    @ViewChild('modalContent') modalContent: ElementRef; //in templateUrl <div #modalContent class="modal-content">
